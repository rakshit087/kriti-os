...
section .text
   ...
   ib: db 0x00
      ...
      mov  sp, rint32_BASE                    ; set correct stack position so we can copy back
   ...
   rint32_end:                                 ; end marker (so we can copy the code)
